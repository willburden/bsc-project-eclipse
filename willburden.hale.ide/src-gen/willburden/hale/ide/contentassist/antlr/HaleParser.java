...
public class HaleParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, HaleGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getElseLetAccess().getGroup_1(), "rule__ElseLet__Group_1__0");
			...
			builder.put(grammarAccess.getIfConditionsAccess().getGroup_4(), "rule__IfConditions__Group_4__0");
			...
			builder.put(grammarAccess.getLetBindingAccess().getMutableAssignment_2(), "rule__LetBinding__MutableAssignment_2");
			builder.put(grammarAccess.getLetBindingAccess().getNameAssignment_3(), "rule__LetBinding__NameAssignment_3");
			builder.put(grammarAccess.getLetBindingAccess().getTypeAssignment_4(), "rule__LetBinding__TypeAssignment_4");
			builder.put(grammarAccess.getLetBindingAccess().getExpressionAssignment_6(), "rule__LetBinding__ExpressionAssignment_6");
			...
			builder.put(grammarAccess.getIfLetAccess().getNameAssignment_2(), "rule__IfLet__NameAssignment_2");
			...
			builder.put(grammarAccess.getElseLetAccess().getNameAssignment_1_1(), "rule__ElseLet__NameAssignment_1_1");
			builder.put(grammarAccess.getElseLetAccess().getTypeAssignment_1_2(), "rule__ElseLet__TypeAssignment_1_2");
			builder.put(grammarAccess.getElseLetAccess().getElseBlockAssignment_2(), "rule__ElseLet__ElseBlockAssignment_2");
			builder.put(grammarAccess.getIfConditionsAccess().getConditionsAssignment_1(), "rule__IfConditions__ConditionsAssignment_1");
			builder.put(grammarAccess.getIfConditionsAccess().getIfBlocksAssignment_2(), "rule__IfConditions__IfBlocksAssignment_2");
			builder.put(grammarAccess.getIfConditionsAccess().getConditionsAssignment_3_1(), "rule__IfConditions__ConditionsAssignment_3_1");
			builder.put(grammarAccess.getIfConditionsAccess().getIfBlocksAssignment_3_2(), "rule__IfConditions__IfBlocksAssignment_3_2");
			builder.put(grammarAccess.getIfConditionsAccess().getElseBlockAssignment_4_1(), "rule__IfConditions__ElseBlockAssignment_4_1");
