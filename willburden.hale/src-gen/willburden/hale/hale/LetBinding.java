 ...
 * </ul>
 *
 * @see willburden.hale.hale.HalePackage#getLetBinding()
 * @model
 * @generated
 */
public interface LetBinding extends Statement
{
   ...
   * @see willburden.hale.hale.HalePackage#getLetBinding_Mutable()
   * @model
   * @generated
   */
  boolean isMutable();
  ...
  /**
   * Sets the value of the '{@link willburden.hale.hale.LetBinding#isMutable <em>Mutable</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setType(Type)
   * @see willburden.hale.hale.HalePackage#getLetBinding_Type()
   * @model containment="true"
   * @generated
   */
  Type getType();
  ...
  /**
   * Sets the value of the '{@link willburden.hale.hale.LetBinding#getType <em>Type</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see willburden.hale.hale.HalePackage#getLetBinding_Expression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link willburden.hale.hale.LetBinding#getExpression <em>Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
